...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>aa", actions.yank_context_file_path, { desc = "Yank context file path to clipboard" })
      vim.keymap.set("x", "<leader>aa", actions.yank_context_range,
        { expr = true, desc = "Yank context range to clipboard" })
      vim.keymap.set("n", "<leader>af", actions.yank_file_path, { desc = "Yank file path to clipboard" })
    end,
  },
  {
