...
local with_alpha = function(color, alpha)
  ...
  -- return bit.bor(bit.band(color, 0x00FFFFFF), bit.lshift(math.floor(alpha * 255), 24))
  return bor(band(color, 0x00FFFFFF), lshift(math.floor(alpha * 255), 24))
end
